	...
	case 15:
		{
			...
			_Unit_Pool_V = ["LOP_ChDKZ_BTR60", "LOP_ChDKZ_UAZ_SPG", "LOP_ChDKZ_UAZ_DshKM", "LOP_ChDKZ_UAZ_AGS"];
...
// Sarahani Liberation Army (LOP) (OPFOR)
	case 16:
		{
			_Unit_Pool_S = ["LOP_SLA_Infantry_Crewman", "LOP_SLA_Infantry_Pilot", "LOP_SLA_Infantry_SL", "LOP_SLA_Infantry_Rifleman", "LOP_SLA_Infantry_AT", "LOP_SLA_Infantry_Rifleman", "LOP_SLA_Infantry_AT", "LOP_SLA_Infantry_GL", "LOP_SLA_Infantry_MG", "LOP_SLA_Infantry_MG", "LOP_SLA_Infantry_Corpsman"];
			_Unit_Pool_V = ["LOP_SLA_UAZ_DshKM","LOP_SLA_BTR60","LOP_SLA_UAZ_AGS","LOP_SLA_UAZ_SPG"];
			_Unit_Pool_T = ["LOP_SLA_BMP1", "LOP_SLA_BMP2", "LOP_SLA_T72BA", "LOP_SLA_BTR60"];
...
// Insurgents (ChDKZ) (RHS) (INDFOR)
	case 21:
		{
			_Unit_Pool_S = ["rhsgref_ins_crew", "rhsgref_ins_pilot", "rhsgref_ins_squadleader", "rhsgref_ins_rifleman", "rhsgref_ins_rifleman_akm", "rhsgref_ins_grenadier", "rhsgref_ins_rifleman_RPG26","rhsgref_ins_specialist_aa","rhsgref_ins_specialist_aa","rhsgref_ins_grenadier_rpg","rhsgref_ins_grenadier_rpg","rhsgref_ins_machinegunner","rhsgref_ins_medic","rhsgref_ins_sniper","rhsgref_ins_spotter"];
			_Unit_Pool_V = ["rhsgref_ins_uaz_dshkm", "rhsgref_ins_uaz_dshkm", "rhsgref_ins_uaz_ags", "rhsgref_ins_uaz_dshkm","rhsgref_BRDM2_HQ_ins","rhsgref_BRDM2_ATGM_ins","rhsgref_BRDM2_ins"];
			_Unit_Pool_T = ["rhsgref_ins_bmp2k", "rhsgref_ins_t72bc", "rhsgref_ins_zsu234","rhsgref_ins_bmd2"];
			_Unit_Pool_A = ["RHS_Mi8MTV3_vdv"];
		};
//-------------------------------------------------------------------------------------------------
	...
	case 22:
		{
			...
			_Unit_Pool_V = ["LOP_AFR_Landrover", "LOP_AFR_Offroad", "LOP_AFR_Landrover_M2", "LOP_AFR_Offroad_M2", "LOP_AM_UAZ_SPG", "LOP_AM_UAZ_DshKM"];
			_Unit_Pool_T = [];
			_Unit_Pool_A = [];
		};
//-------------------------------------------------------------------------------------------------
	...
	case 23:
		{
			...
			_Unit_Pool_V = ["LOP_AM_Landrover_M2", "LOP_AM_Offroad", "LOP_AM_Offroad_M2","LOP_AM_UAZ_AGS", "LOP_AM_UAZ_DshKM", "LOP_AM_UAZ_SPG"];
	...
	case 25:
		{
			...
			_Unit_Pool_V = ["LOP_RACS_Landrover", "LOP_RACS_Landrover_M2", "LOP_RACS_Offroad_M2", "LOP_UKR_BTR60"];
			_Unit_Pool_T = ["LOP_RACS_M113_W", "LOP_RACS_T72BA", "LOP_UKR_BMP2"];
